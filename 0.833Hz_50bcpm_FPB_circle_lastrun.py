...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\weberbe\\Nextcloud\\__PsychoPy\\__Paradigmen_HD-Labor__\\fast_paced_breathing\\0.833Hz_50bcpm_FPB_circle_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    ##  marker: FPB (0.833Hz, 50bcpm) task START  ##
    Marker.setData(151); core.wait(0.1); Marker.setData(0)
    ...
    for thisFPB_byp in FPB_byp:
        ...
        ##  marker: FPB (0.833Hz, 50bcpm) START  ##
        ...
        ##  marker: FPB (0.833Hz, 50bcpm) STOP  ##
    ...
    ##  marker: FPB (0.833Hz, 50bcpm) task STOP  ##
    Marker.setData(153); core.wait(0.1); Marker.setData(0)
