...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\weberbe\\Nextcloud\\__PsychoPy\\__Paradigmen_HD-Labor__\\fast_paced_breathing\\0.6Hz_36bcpm_FPB_circle.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    ##  marker: FPB (0.6Hz, 36bcpm) task START  ##
    Marker.setData(137); core.wait(0.1); Marker.setData(0)
    ...
    for thisFPB_byp in FPB_byp:
        ...
        ##  marker: FPB (0.6Hz, 36bcpm) START  ##
        Marker.setData(37); core.wait(0.1); Marker.setData(0)
        ...
        ##  marker: FPB (0.6Hz, 36bcpm) START  ##
        Marker.setData(39); core.wait(0.1); Marker.setData(0)
    ...
    ##  marker: FPB (0.6Hz, 36bcpm) task STOP  ##
    Marker.setData(139); core.wait(0.1); Marker.setData(0)
