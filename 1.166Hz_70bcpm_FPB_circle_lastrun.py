...
expName = '1.166Hz_70bcpm_FPB_circle'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\weberbe\\Nextcloud\\__PsychoPy\\__Paradigmen_HD-Labor__\\fast_paced_breathing\\1.166Hz_70bcpm_FPB_circle_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    ##  marker: FPB (1.166Hz, 70bcpm) task START  ##
    Marker.setData(171); core.wait(0.1); Marker.setData(0)
    ...
    for thisFPB_byp in FPB_byp:
        ...
        ##  marker: FPB (1.166Hz, 70bcpm) START  ##
        Marker.setData(71); core.wait(0.1); Marker.setData(0)
        ...
        ##  marker: FPB (1.166Hz, 70bcpm) STOP  ##
        Marker.setData(73); core.wait(0.1); Marker.setData(0)
    ...
    ##  marker: FPB (1.0Hz, 60bcpm) task STOP  ##
    Marker.setData(173); core.wait(0.1); Marker.setData(0)
